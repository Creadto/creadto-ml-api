...
import com.creadto.ml.core.domain.ExampleResult
import io.dodn.springboot.core.domain.ExampleService
import com.creadto.ml.RestDocsTest
import com.creadto.ml.RestDocsUtils.requestPreprocessor
import com.creadto.ml.RestDocsUtils.responsePreprocessor
...
class ExampleControllerTest : RestDocsTest() {
    ...
    @Test
    fun exampleGet() {
        every { exampleService.processExample(any()) } returns com.creadto.ml.core.domain.ExampleResult("BYE")
    ...
    fun examplePost() {
        ...
        given()
            .contentType(ContentType.JSON)
            .body(com.creadto.ml.core.api.controller.v1.request.ExampleRequestDto("HELLO_BODY"))
            .post("/post")
            .then()
            .status(HttpStatus.OK)
            .apply(
